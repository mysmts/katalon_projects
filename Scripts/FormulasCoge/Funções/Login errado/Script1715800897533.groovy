...
WebUI.setText(findTestObject('Object Repository/Login/Page_Frmulas COGE  - Log In/input_E-mail_Email'), 'jordino@funcoge.com.br')
...
WebUI.verifyElementPresent(findTestObject('Login/Page_Frmulas COGE  - Log In/New Test Object'), 0)
